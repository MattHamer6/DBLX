...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_script( 'inview', get_template_directory_uri() . '/js/inview.min.js', array(), $js_version, true );
		wp_enqueue_script( 'Scrollify', get_template_directory_uri() . '/js/jquery.scrollify.js', array(), $js_version, true );
		wp_enqueue_script( 'anime', get_template_directory_uri() . '/js/anime.min.js', array(), $js_version, true );
